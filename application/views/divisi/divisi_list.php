              ...
              <div class="box-header with-border">
                ...
                <div class="box-body">
                   <form method="post" action="<?php echo $current_context . 'search'; ?>" class="form-horizontal" enctype="multipart/form-data">
                        <?php $key = (object) $this->session->userdata('filter_divisi'); ?>
                    ...
                    <table class="table table-hover" id="table_data">
                        ...
                        foreach ($divisi as $row) {
                            ...
                            <tr>
                                ...
                                <td class="td-btn">
                                    <!-- <a href="<?php echo $current_context . 'detail' . '/' . $row->id_divisi ?>" class="badge bg-yellow"><i class="fa fa-eye fa-fw"></i>lihat</a> -->
                                    <a href="<?php echo $current_context . 'edit' . '/' . $row->id_divisi ?>" class="badge bg-green"><i class="fa fa-edit fa-fw"></i>Ubah</a>
                                    <a href="#" data-href="<?php echo $current_context . 'delete' . '/' . $row->id_divisi ?>" data-toggle="modal" data-target="#deleteModal"  class="badge bg-red"><i class="fa fa-trash-o fa-fw"></i>Hapus</a>
                                </td>
                            </tr>
                        <?php $i++;
                        } ?>
