              ...
              <div class="box-header with-border">
                ...
                <div class="box-body">
                   <form method="post" action="<?php echo $current_context . 'search'; ?>" class="form-horizontal" enctype="multipart/form-data">
                        <?php $key = (object) $this->session->userdata('filter_gaji_karyawan'); ?>
                ...
                <div class="box-header">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <button class="btn btn-default" data-toggle="modal" name="excel" data-target="#input-gaji"><i class="fa fa-plus"></i> Input Data Gaji</button> 
                    </div>
                </div><!-- /.box-header -->
                    ...
                    <table class="table table-hover" id="table_data">
                        ...
                        foreach ($gaji_karyawan as $row) {
                            ...
                            <tr>
                                ...
                                <td class="td-btn">
                                    <!-- <a href="<?php echo $current_context . 'detail' . '/' . $row->id_gaji_karyawan ?>" class="badge bg-yellow"><i class="fa fa-eye fa-fw"></i>Detail</a> -->
...
<!-- ============ MODAL ADD =============== -->
        <div class="modal fade" id="input-gaji" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h3 class="modal-title" id="myModalLabel">Input Data Gaji</h3>
                <h4>Periode</h4>
            
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url().'gaji_karyawan/input_gaji'?>">
