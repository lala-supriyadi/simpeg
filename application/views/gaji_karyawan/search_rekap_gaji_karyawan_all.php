              ...
              <div class="box-header with-border">
                ...
                <div class="box-body">
                   <form method="post" action="<?php echo $current_context . 'cek'; ?>" class="form-horizontal">
                        ...
                        <div class="clearfix pull-right">
                            ...
                            <button type="button" class="btn btn-sm btn-default" onclick="location.href = '<?php echo $current_context . 'rekap_gaji'; ?>'">Reset</button>
                        </div>
                    </form>
                </div><!-- /.box-body -->
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover" id="table_data">
                        ...
                        <?php
                        $i=1;
                        foreach ($getTotalAll as $raw) {
                            ?>

                        <?php
                        // $i=1;
                        foreach ($getGajikaryawanAll as $row) {
                            ...
                            <tr>
                                ...
                                <td><?php echo "Rp " . number_format($row->cek_thp,0,',','.'); ?></td>
                                <td class="td-btn">
                        ...
                        <tr>
                            <td colspan="8" style="text-align:center;"><b>Total</b></td>
                             <td style="text-align:left;"><b><?php echo "Rp " . number_format($raw->jumlah_jumlah,0,',','.'); ?></b></td>  
