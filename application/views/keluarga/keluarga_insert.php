...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo $current_context; ?>">Keluarga</a></li>
                ...
                <div class="box-body">
                    <form role="form" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="col-md-10">
                                         <select class="form-control select2me" name="id_karyawan" data-placeholder="Pilih..."  id="id_karyawan">
                                            ...
                                            <?php foreach ($karyawan_list as $row) {
                                                if ($row->id_karyawan == set_value('id_karyawan',$keluarga->id_karyawan)){
                        ...
                        <div class="form-group <?php echo (form_error('nik') != "") ? "has-error" : "" ?>">
                            <label class="control-label col-md-2">NIK</label><div class="col-md-10"><input class="form-control " name="nik" type="text" value="<?php echo set_value('nik', $keluarga->nik); ?>" placeholder="NIK"  maxlength=100 required></div>
                            <?php echo form_error('nik'); ?>
                        </div>

                        <div class="form-group <?php echo (form_error('nama_keluarga') != "") ? "has-error" : "" ?>">
                            <label class="control-label col-md-2">Nama Keluarga</label><div class="col-md-10"><input class="form-control " name="nama_keluarga" type="text" value="<?php echo set_value('nama_keluarga', $keluarga->nama_keluarga); ?>" placeholder="Nama Keluarga"  maxlength=100 required></div>
                            <?php echo form_error('nama_keluarga'); ?>
                        </div>

                        <div class="form-group">
                            <div class="col-md-6">
                                <div class="form-group <?php echo (form_error('tempat_lahir') != "") ? "has-error" : "" ?>">
                                    <label class="control-label col-md-4">Tempat Lahir</label><div class="col-md-8"><input class="form-control " name="tempat_lahir" type="text" value="<?php echo set_value('tempat_lahir', $keluarga->tempat_lahir); ?>" placeholder="Tempat Lahir"  maxlength=100 required></div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group <?php echo (form_error('tgl_lahir') != "") ? "has-error" : "" ?>">
                                    <label class="control-label col-md-4">Tanggal Lahir</label><div class="col-md-8"><input class="form-control " name="tgl_lahir" type="date" value="<?php echo set_value('tgl_lahir', $keluarga->tgl_lahir); ?>" placeholder="Tanggal Lahir"  maxlength=100 required></div>
                        ...
                        <div class="form-group <?php echo (form_error('pendidikan') != "") ? "has-error" : "" ?>">
                            ...
                            <select class="form-control select2me" name="pendidikan" required>
                                ...
                                <?php if($keluarga->pendidikan == 'SD'):?>
                                    ...
                                    <option value="S1">S1</option>
                                    <option value="S2">S2</option>
                                <?php elseif($keluarga->pendidikan == 'SMP'):?>
                                    <option value="SD">SD</option>
                                    ...
                                    <option value="S1">S1</option>
                                    <option value="S2">S2</option>
                                <?php elseif($keluarga->pendidikan == 'SMA'):?>
                                    <option value="SD">SD</option>
                                    <option value="SMP">SMP</option>
                                    ...
                                    <option value="S1">S1</option>
                                    <option value="S2">S2</option>
                                <?php elseif($keluarga->pendidikan == 'D3'):?>
                                    <option value="SD">SD</option>
                                    <option value="SMP">SMP</option>
                                    <option value="SMA">SMA</option>
                                    ...
                                    <option value="S1">S1</option>
                                    <option value="S2">S2</option>
                                <?php elseif($keluarga->pendidikan == 'S1'):?>
                                    <option value="SD">SD</option>
                                    <option value="SMP">SMP</option>
                                    <option value="SMA">SMA</option>
                                    <option value="D3">D3</option>
                                    ...
                                    <option value="S2">S2</option>
                                <?php elseif($keluarga->pendidikan == 'S2'):?>
                                    <option value="SD">SD</option>
                                    <option value="SMP">SMP</option>
                                    <option value="SMA">SMA</option>
                                    <option value="D3">D3</option>
                        ...
                        <div class="form-group <?php echo (form_error('pekerjaan') != "") ? "has-error" : "" ?>">
                            <label class="control-label col-md-2">Pekerjaan</label><div class="col-md-10"><input class="form-control " name="pekerjaan" type="text" value="<?php echo set_value('pekerjaan', $keluarga->pekerjaan); ?>" placeholder="Pekerjaan"  maxlength=100 required></div>
                        ...
                        <div class="form-group <?php echo (form_error('hubungan') != "") ? "has-error" : "" ?>">
                            ...
                            <select class="form-control select2me" name="hubungan" >
                                ...
                                <?php if($keluarga->hubungan == 'Suami'):?>
                                    <option value="Suami" selected>Suami</option>
                                    <option value="Istri">Istri</option>
                                <?php elseif($keluarga->hubungan == 'Istri'):?>
                                    <option value="Suami">Suami</option>
