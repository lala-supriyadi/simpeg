              ...
              <div class="box-header with-border">
                ...
                <div class="box-body">
                   <form method="post" action="<?php echo $current_context . 'search'; ?>" class="form-horizontal" enctype="multipart/form-data">
                        <?php $key = (object) $this->session->userdata('filter_penempatan'); ?>
                        <div class="col-md-6"><div class="form-group">
                                <label class="control-label col-md-5">Nama Perusahaan</label>
                                <div class="col-md-7"><input class="form-control " name="nama_perusahaan" value="<?php echo $key->nama_perusahaan; ?>" placeholder="Nama Perusahaan">
                                </div>
                            </div>
                        </div>
                    ...
                    <table class="table table-hover" id="table_data">
                        ...
                        foreach ($penempatan as $row) {
                            ...
                            <tr>
                                ...
                                <td class="td-btn">
                                    <!-- <a href="<?php echo $current_context . 'detail' . '/' . $row->id_penempatan ?>" class="badge bg-yellow"><i class="fa fa-eye fa-fw"></i>lihat</a> -->
                                    <a href="<?php echo $current_context . 'edit' . '/' . $row->id_penempatan ?>" class="badge bg-green"><i class="fa fa-edit fa-fw"></i>Ubah</a>
                                    <a href="#" data-href="<?php echo $current_context . 'delete' . '/' . $row->id_penempatan ?>" data-toggle="modal" data-target="#deleteModal"  class="badge bg-red"><i class="fa fa-trash-o fa-fw"></i>Hapus</a>
                                </td>
                            </tr>
                        <?php $i++;
                        } ?>
